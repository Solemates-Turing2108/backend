...
#pip install ipython
#look up heroku port and db name
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql:postgres:198645@localhost/sole_mates' #to connect the app to the database
...
app.config['MAIL_USERNAME'] = 'solematesturing@gmail.com'
app.config['MAIL_PASSWORD'] = 'TestTuring'
...
app.config['MAIL_DEFAULT_SENDER'] = 'solematesturing@gmail.com'  #if you don't specify the sender, this will be sent
# or you can also add:
...
def add_shoe():
    shoe = Shoe(side=request.json["side"],
...
def delete_shoe(id):
    ...
    return {"message": "the shoe has been deleted!"}
